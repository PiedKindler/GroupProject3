...
query = "SELECT name FROM inventory_items"
cursor.execute(query)

# Create a list of inventory items from the query results
inventory_items = []
for item in cursor:
    inventory_items.append(item)

query = "SELECT supplier_name FROM inventory_items"
cursor.execute(query)

# Create a list of suppliers from the query results
supplier_names = []
for item in cursor:
    supplier_names.append(item)
